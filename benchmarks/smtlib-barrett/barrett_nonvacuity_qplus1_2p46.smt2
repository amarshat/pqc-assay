...
(set-info :source |
 ...
 conditional subtraction yields x mod Q). NON-VACUITY MUTANT: Q replaced by Q+1 = 8380418, so the bound is violated; a sat witness exists (x = 16760835). Input domain x < 2^46.
...
(define-fun Q () (_ BitVec 128) (_ bv8380418 128))
(assert (bvult x (_ bv70368744177664 128)))
