...
no vendor verification artifacts; the main proof pipeline runs from a single command, and the timeout and
encoding experiments are reproduced by self-contained scripts.
\end{abstract}
...
identify but have not yet realized. Mechanizing the transform layer through these escapes is the immediate
next step.
