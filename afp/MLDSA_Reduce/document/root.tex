...
\begin{abstract}
FIPS 204~\cite{fips204} fixes the prime modulus $q = 8380417$ for ML-DSA. Deployed implementations reduce values
modulo $q$ with a small layer of routines that the standard does not itself spell out: Montgomery
reduction~\cite{montgomery1985}, a Barrett-style \emph{reduce32}, a conditional addition and their composition. This entry
